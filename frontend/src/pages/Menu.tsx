...
const africanSoups: MenuItem[] = [
  ...
  },
  {
    ...
    varieties: [{ name: "With White Rice", price: 15.0, image: "/images/menu/white_rice.jpg" }],
  },
  {
    id: 6,
...
const caribbeanFavourites: MenuItem[] = [
  {
    ...
    name: "Curry Goat",
    price: 12.5,
    image: "/images/menu/currygoat.jpg",
    varieties: [
  ...
  { id: 15, name: "Stew Chicken", price: 12.5, image: "/images/menu/chicken_stew.jpg" },
  { id: 21, name: "Seafood Combo", price: 12.5, image: "/images/menu/sea_food_combo.jpg" },
  {
    id: 24,
    name: "Rice & Peas",
    price: 0,
    image: "/images/menu/riceandpeas.jpg",
    varieties: [
      { name: "With Curry Goat", price: 15.0, image: "/images/menu/currygoat.jpg" },
      { name: "with Oxtail", price: 15.0, image: "images/menu/oxtailandpeas.jpg" },
    ],
  },
];
...
// 🌊 Seafood
const seafood: MenuItem[] = [{ id: 19, name: "Crayfish", price: 0, image: "/images/menu/Crayfishb.jpg" }];
...
export default function Menu() {
  ...
  const VarietyCard = ({
    ...
    const handleClick = () => {
      ...
      if (includeVeg && variety.hasOptionalVeg) {
        selectedVariety = {
          ...variety,
          name: `${variety.name} + Steamed Vegetables (Free)`,
        };
      }
      handleAddToCart(item, selectedVariety);
    };
      ...
      <div className="cursor-pointer bg-yellow-50 hover:bg-yellow-100 rounded-xl shadow p-3 transition transform hover:scale-105">
        ...
        {variety.hasOptionalVeg && (
          <div className="flex items-center justify-center mt-2 gap-2">
            ...
            />
            <label className="text-sm text-gray-700">Add Steamed Vegetables (Free)</label>
          </div>
        )}
        ...
        <div className="flex justify-center mt-3">
          <button
            onClick={handleClick}
            className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-4 py-2 rounded-lg shadow hover:opacity-90 transition"
          >
            Add to Cart
          </button>
        </div>
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-center my-6">Our Menu 🍴</h2>
